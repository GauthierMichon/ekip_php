 ...
 */
final class Version20201107094512 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offres (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, contrat_type VARCHAR(255) NOT NULL, contrat_duration VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, salaire INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
